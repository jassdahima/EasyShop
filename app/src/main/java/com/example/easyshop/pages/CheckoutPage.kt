...
fun CheckoutPage(modifier: Modifier = Modifier){
    ...
    Column(modifier = Modifier.fillMaxSize()
       ...
       Text(text = userModel.value.name)
        ...
        Spacer(modifier = Modifier.height(16.dp))
        RowCheckoutPage(title = "Subtotal", value = subTotal.value.toString())

        Spacer(modifier = Modifier.height(8.dp))
        RowCheckoutPage(title = "Discount (-)", value = discount.value.toString())

        Spacer(modifier = Modifier.height(8.dp))
        RowCheckoutPage(title = "Tax (+)", value = tax.value.toString())
        Spacer(modifier = Modifier.height(16.dp))
        HorizontalDivider()
        Spacer(modifier = Modifier.height(16.dp))
        Text(
